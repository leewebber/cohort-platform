...
print("FIXTURE_OBJECTS_FOUND=" + str(result.get("fixture_objects_found", 0)))
print("ALL_REQUIRED_LOOKUPS=" + str(result.get("all_required_lookups")))
print("CURRENT_PROTOCOL_LOOKUP=" + str(result.get("current_protocol_lookup")))
print("LATER_PROTOCOL_LOOKUP=" + str(result.get("later_protocol_lookup")))
