...
/// Service-role capture-metadata repair. Does not enrol or mutate assignments.
Future<void> main(List<String> args) async {
  ...
  try {
    final response = await client.rpc(
      'repair_private_programme_exercise_capture',
    ...
    stdout.writeln('updated_exercises=${map['updated_exercises']}');
    stdout.writeln('unchanged_exercises=${map['unchanged_exercises']}');
