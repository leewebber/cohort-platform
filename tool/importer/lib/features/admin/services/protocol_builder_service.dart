...
import 'package:founder_importer/data/repositories/protocol_repository.dart';
import 'package:founder_importer/data/repositories/protocol_step_repository.dart';
import 'package:founder_importer/data/repositories/session_block_repository.dart';
import 'package:founder_importer/data/repositories/session_lineage_store.dart';
import 'package:founder_importer/data/repositories/session_lineage_supabase_store.dart';
import 'package:founder_importer/models/protocol_builder_save_result.dart';
import 'package:founder_importer/models/protocol_draft.dart';
import 'package:founder_importer/models/protocol_draft_summary.dart';
...
import 'package:founder_importer/features/session_builder/services/protocol_draft_block_resolver.dart';
import 'package:founder_importer/features/session_builder/services/session_block_validation.dart';
...
class ProtocolBuilderService {
  ...
  Future<ProtocolDraft> loadProtocol(String protocolId) async {
    ...
    try {
      final protocolRow = await SupabaseClientHolder.client
          .from('performance_protocols')
          .select()
  ...
  Future<ProtocolBuilderSaveResult> _persistDraft(
    ...
    try {
      ...
      if (stepMaps.isNotEmpty) {
        await SupabaseClientHolder.client.from('protocol_steps').insert(stepMaps);
      }
