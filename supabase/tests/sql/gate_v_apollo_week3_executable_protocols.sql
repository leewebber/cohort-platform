...
BEGIN
 ...
 SELECT count(*) INTO v_count FROM performance_protocols WHERE protocol_id LIKE 'APOLLO-W3-%-R1' AND authoring_scope='organisation' AND organisation_id='apollo-dogfood' AND lifecycle_status='published' AND published='true' AND published_at IS NOT NULL;
 ...
 PERFORM sprint12_assert_eq('V','week1_week2_exercise_row_counts_unchanged','164',v_count::text);
 BEGIN
