#!/usr/bin/env bash
# Dedicated local disposable gate for private protocol-graph publication/repair.
...
run_be
echo "=== Private protocol graph gate pass 2 (reset/replay) ==="
run_be
echo "PRIVATE_PROTOCOL_GRAPH_GATE=PASS"
