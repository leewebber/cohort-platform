...
void main() {
  test(
    ...
    () {
      ...
      expect(
        files.last,
        '20260924120000_completed_fixed_programme_calendar_inspection.sql',
      );
      expect(
        files,
        contains('20260918120400_content_graph_reconstruction.sql'),
      );
      expect(
        files,
        contains('20260919120000_publisher_athlete_membership_core.sql'),
      );
      expect(
        files,
        contains(
