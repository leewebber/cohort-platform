...
void main() {
  ...
  test(
    'coach athlete migration defines relationships, invites, and acceptance',
    () {
      ...
      expect(
        sql,
        contains('CREATE TABLE IF NOT EXISTS coach_athlete_relationships'),
      );
      expect(sql, contains('CREATE TABLE IF NOT EXISTS coach_athlete_invites'));
      expect(sql, contains('accept_coach_athlete_invite'));
      expect(
        sql,
        contains('coach_athlete_relationships_one_active_per_athlete'),
      );
