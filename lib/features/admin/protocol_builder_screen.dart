...
class ProtocolBuilderScreen extends StatefulWidget {
  const ProtocolBuilderScreen({super.key, this.protocolId});
...
class _ProtocolBuilderScreenState extends State<ProtocolBuilderScreen> {
  ...
  ProtocolDraft _draft = ProtocolDraft(protocolId: '', name: '', steps: []);
  ...
  void _savePublishedChanges() async {
    ...
    try {
      final result = await _builderService.savePublishedChanges(_draft);
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Text('Unpublish protocol?', style: CohortTextStyles.h2),
          content: Text(
  ...
  Future<void> _showSaveSuccessDialog(ProtocolBuilderSaveResult result) async {
    final startNewDraft = await showDialog<bool>(
      ...
      builder: (context) {
        return AlertDialog(
          backgroundColor: CohortColors.surface,
          title: Text('Draft saved', style: CohortTextStyles.h2),
          content: Text(
            '${result.message}\n\nStart a new draft?',
            style: CohortTextStyles.body,
          ),
  ...
  Future<void> _showPublishSuccessDialog(
    ...
    await showDialog<void>(
      ...
      builder: (context) {
        return AlertDialog(
          backgroundColor: CohortColors.surface,
          title: Text('Protocol published', style: CohortTextStyles.h2),
          content: Text(result.message, style: CohortTextStyles.body),
          actions: [
            TextButton(
  ...
  Future<void> _showSavedChangesDialog(ProtocolBuilderSaveResult result) async {
    await showDialog<void>(
      context: context,
      builder: (context) {
        return AlertDialog(
          backgroundColor: CohortColors.surface,
          title: Text('Changes saved', style: CohortTextStyles.h2),
          content: Text(result.message, style: CohortTextStyles.body),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
  ...
  Future<void> _showUnpublishSuccessDialog(
    ...
    await showDialog<void>(
      ...
      builder: (context) {
        return AlertDialog(
          backgroundColor: CohortColors.surface,
          title: Text('Protocol unpublished', style: CohortTextStyles.h2),
          content: Text(result.message, style: CohortTextStyles.body),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: CohortSpacing.md),
                    Text(displayContext.title, style: CohortTextStyles.h1),
                    ...
                    SessionBuilderView(
                      ...
                      capabilities:
                          SessionBuilderCapabilities.cohortProtocolAdmin(
