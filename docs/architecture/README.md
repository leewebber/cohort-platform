...
| [../checkpoints/M9_FIELD_MANUAL_PUBLICATION_QUALIFICATION.md](../checkpoints/M9_FIELD_MANUAL_PUBLICATION_QUALIFICATION.md) | Field Manual Phase 3A publication qualification (read-only) |
