...
**Phase 2 is CLOSED. Phase 3 — Exercise Database has started (3.1A–3.1D
committed; 3.1E relationship graph complete pending review).** Start from
...
[`Phase_3_1D_Canonical_Exercise_Identity_Bridge_v1.md`](./Phase_3_1D_Canonical_Exercise_Identity_Bridge_v1.md),
and
...
**CLOSED**. Canonical programme architecture is **frozen**. Phase 3.1A–3.1D are
**committed**. Phase 3.1E relationship graph is **complete** (pending review; no
live consumer migration; Phase 3.1 not complete). See
[`Phase_3_1E_Exercise_Relationship_Graph_v1.md`](./Phase_3_1E_Exercise_Relationship_Graph_v1.md),
[`Phase_3_1D_Canonical_Exercise_Identity_Bridge_v1.md`](./Phase_3_1D_Canonical_Exercise_Identity_Bridge_v1.md),
[`Canonical_Programme_Architecture_Freeze_v1.md`](./Canonical_Programme_Architecture_Freeze_v1.md),
