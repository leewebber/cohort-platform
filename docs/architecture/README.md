...
**Phase 2 is CLOSED. Phase 3 — Exercise Database has started (3.1A–3.1C
committed; 3.1D identity bridge complete pending review).** Start from
...
**CLOSED**. Canonical programme architecture is **frozen**. Phase 3.1A–3.1C are
**committed**. Phase 3.1D identity bridge is **complete** (pending review; no
